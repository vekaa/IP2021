...
<body>
<header><?php include '../view/templates/header.php';?></header>
<nav><?php include '../view/templates/nav.php';?></nav>

    <form action="../controller/controllerOsobe.php" method="POST">
        Ime: <br>
...
<footer><?php include '../view/templates/footer.php';?></footer>
</body>
</html>

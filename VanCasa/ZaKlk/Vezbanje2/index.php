...
<body>
    <div class="container text-center">
        ...
        <div class="row" style="height: 300px; align-items: center;">
            <div class="col-sm-4">
                <a href="slika.php"><img src="images/1.jpg" alt="slika1" style="width: 200px;"></a>
            </div>
            <div class="col-sm-4">
                <a href="slika.php"><img src="images/2.jpg" alt="slika2" style="width: 200px;"></a>
            </div>
            <div class="col-sm-4">
                <a href="slika.php"><img src="images/3.jpg" alt="slika3" style="width: 200px;"></a>
            </div>
        </div>
        <!-- FOOTER -->
        <div class="row">
